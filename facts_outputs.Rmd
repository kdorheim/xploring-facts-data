...
```{r fig.cap = 'Figure 2. The fittedismip.ssp585 experiment, plotted with 2000 climate input samples from FaIR and Hector. (experiment description).', echo=FALSE}
# Plot experiment output
ggplot() +
...
```{r fig.cap = 'Figure 3. The larmip.ipccar6.ssp585 experiment. This experiment does not use SCM input from FaIR.', echo=FALSE}
# Plot experiment output
ggplot() +
    geom_ribbon(data = f_slr_stats,
                aes(x=year, ymin=min, ymax=max), color="#F8766D", fill="#F8766D",linetype=0,alpha=0.2) +
...
```{r fig.cap = 'Figure 4. The tlm.global experiment, plotted with 2000 climate input samples from both FaIR and Hector.', echo=FALSE}
# Plot experiment output
ggplot() +
    geom_ribbon(data = h_slr_stats,
                aes(x=year, ymin=min, ymax=max), color="#00BFC4", fill="#00BFC4",linetype=0,alpha=0.2) +
